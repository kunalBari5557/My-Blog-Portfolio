        ...
        <Row>
          <Col md={16} className="home-about-description">
            ...
            <p className="home-about-body">
              Hi,👋 I'm <span style={{ color: "#0A81Ac", fontStyle: "italic" }}>Kunal Aage</span> an aspiring and determined <span style={{ color: "#0A81AB", fontStyle: "italic" }}>Full Stack Web Developer</span>,  with strong communication skills, good attention to detail and with the ability to write efficient code using <span style={{ color: "#0A81Ac", fontStyle: "italic" }}>MERN Stack.</span>
              I Well versed in coding using Javascript and its frameworks, both in front-end and back-end.
